...
from models.my_net import ViT2GNN_AB
...
if __name__ == '__main__':
	...
	for i in range(1):
		...
		with torch.no_grad():
			fusion_net = ViT2GNN_AB(swinT_base=swin_base, vig_base=gcn_base)
			#print('\n', '########################## Net_summary #########################')
		...
		weight_save_path = f'./result/esophagel/base_AB.pth'
		log_file_path = f'./result/esophagel/base_AB.txt'
