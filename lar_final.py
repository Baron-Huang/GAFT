...
if __name__ == '__main__':
	...
	for i in range(5):
		...
		swin_weight = 0.9
		vig_weight = 0.9
		dis_weight = 0.5 + 0.05 * i
		weight_save_path = f'./result/lar/aamff_moo_dis_loss{fusion_weight}*fusion_loss+{swin_weight}*swint_loss+{vig_weight}*vig_loss+{dis_weight}*dis_loss_{i + 1}.pth'
		log_file_path = f'./result/lar/aamff_moo_dis_loss{fusion_weight}*fusion_loss+{swin_weight}*swint_loss+{vig_weight}*vig_loss_LOG+{dis_weight}*dis_loss_LOG_{i + 1}.txt'
