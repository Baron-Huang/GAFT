...
if __name__ == '__main__':
    ...
    for i in range(8):
        ...
        entropy_weight = 1.0
        weight_save_path = f'./result/lar/{fusion_weight}*fusion_weight+{probability_weight}*probability_weight+{entropy_weight}*entropy_weight.pth'
        log_file_path = f'./result/lar/{fusion_weight}*fusion_weight+{probability_weight}*probability_weight+{entropy_weight}*entropy_weight.txt'
