...
if __name__ == '__main__':
	...
	for i in range(1):
		...
		vmamba_weight = 0.25
		dis_weight = 0.75
		weight_save_path = f'./result/esophagel/fdaf_moo_dis_loss_{fusion_weight}*fusion_loss+{swin_weight}*swint_loss+{vmamba_weight}*vig_loss+{dis_weight}*dis_loss.pth'
		log_file_path = f'./result/esophagel/fdaf_moo_dis_loss_{fusion_weight}*fusion_loss+{swin_weight}*swint_loss+{vmamba_weight}*vig_loss+{dis_weight}*dis_loss_LOG.txt'
