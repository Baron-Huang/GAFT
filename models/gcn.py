...
@register_model
def vig_ti_224_gelu(pretrained=False, class_num=None, **kwargs):
	class OptInit:
		def __init__(self, num_classes=3, drop_path_rate=0.0, drop_rate=0.0, num_knn=9, **kwargs):
			self.k = num_knn  # neighbor num (default:9)
			self.conv = 'mr'  # graph conv layer {edge, mr，gat}
