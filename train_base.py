...
if __name__ == '__main__':
	...
	for i in range(1):
		...
		weight_save_path = f'./result/esophagel/base_single.pth'
		log_file_path = f'./result/esophagel/base_single.txt'
		...
		with contextlib.redirect_stdout(print_capture_1) as f:
			train_single(net=fusion_net, train_loader=train_loader, val_loader=val_loader, test_loader=test_loader,
		...
		with contextlib.redirect_stdout(print_capture_2) as f:
			testing_funnction(test_model=fusion_net, train_loader=train_loader, val_loader=val_loader, test_loader=test_loader,
							  gpu_device=device, out_mode='single')
