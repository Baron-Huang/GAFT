...
import random
from models.vit_gnn_utils import train_baseline
...
if __name__ == '__main__':
	...
	for i in range(1):
		...
		weight_save_path = f'./result/esophagel/base_vit_gnn.pth'
		log_file_path = f'./result/esophagel/base_vit_gnn.txt'
		...
		with contextlib.redirect_stdout(print_capture_1) as f:
			train_baseline(number=i+1, fusion_net=fusion_net, train_loader=train_loader, val_loader=val_loader, test_loader=test_loader,
