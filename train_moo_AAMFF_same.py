...
if __name__ == '__main__':
	...
	for i in range(5):
		...
		fusion_weight = 0.7
		swin_weight = 0.5
		vig_weight = 0.1 + 0.1 * i
		weight_save_path = f'./result/esophagel/moo_and_aamff/aamff_moo_{fusion_weight}*fusion_loss+{swin_weight}*swint_loss+{vig_weight}*vig_loss_{i + 1}.pth'
		log_file_path = f'./result/esophagel/moo_and_aamff/aamff_moo_{fusion_weight}*fusion_loss+{swin_weight}*swint_loss+{vig_weight}*vig_loss_LOG_{i + 1}.txt'
